...
<html lang="en">
  ...
  <body>
    ...
    <div class="container" id="buslistcontainer">
        ...
        <c:forEach var="singlebus" items="${bus}">
        <c:forEach var="busRoute" items="${singlebus.busRoutes}">
            <div class="row mt-3">
                <div class="col-1"></div>
                <div class="col">
                    <div class="row card flex-row ps-0">
                        <div class="col-2 ps-0">
                        <img
                            class="img-thumbnail rounded float-start ms-0"
                            src="https://image.shutterstock.com/image-vector/bus-logo-vector-260nw-1158097885.jpg"
                            alt="Bus_Image"
                            height="150"
                            width="100"
                        />
                        ...
                        <div class="row">
                            <div class="col">
                            <h4 class="card-title">${singlebus.travelsName}</h4>
                            </div>
                            <div class="col">
                            <p class="badge bg-secondary">${singlebus.busType}</p>
                            </div>
                        </div>
                        <span class="card-text pe-2">Start Place:</span
                        ><span class="card-text text-muted pe-2"
                            >${singlebus.startTerminal}</span
                        ><span class="card-text pe-2">Destination place:</span
                        ><span class="card-text text-muted pe-2"
                            >${singlebus.endTerminal}</span
                        >
                        </div>
                        ...
                        <button
                            ...
                            onClick="bookTickets('${busRoute.id}','${singlebus.travelsName}')"
                        >
                            Book Tickets
                        </button>
                        </div>
